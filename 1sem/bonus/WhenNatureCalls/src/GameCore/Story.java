...
public class Story {
    ...
    public void square(){
        ...
        ui.mainTextArea.setText("Вы выходите на городскую площадь. Прямо перед собой вы видите длинную улицу, в конце которой возвышается гигантский Королевский Замок. Взглянув налево, " +
    ...
    public void blacksmith(){
        ui.mainTextArea.setText("Кузнец: Здравствуй, давненько ко мне не заходил кто-то не из стражи. Но я рад любому покупателю. Я щедрый, поэтому можешь" +
