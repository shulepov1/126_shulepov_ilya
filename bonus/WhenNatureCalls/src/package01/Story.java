...
public class Story {
    ...
    String finalapplause = ".//res//applause2.wav";
    ...
    public void simon(){
        ...
        ui.hpNumberLabel.setText(""+player.hp);
        player.currentWeapon = new Weapon_God();
        ui.weaponNameLabel.setText(player.currentWeapon.name);
    ...
    public void whaleLeft(){
        monster = new Monster_Samurai();
    ...
    public void swampKnight(){
        monster = new Monster_DyingKnight();
    ...
    public void hammer(){
        if (player.coin >= 20) {
            ui.mainTextArea.setText("Ваше оружие: " + player.currentWeapon.name + ".\nВы действительно хотите купить Молот?");
    ...
    public void hammerOk(){
        player.currentWeapon = new Weapon_Hammer();
    ...
    public void rapierOk(){
        player.currentWeapon = new Weapon_Rapier();
    ...
    public void fountainHostage(){
        ui.mainTextArea.setText("Вы хватаете мужчину и пристявляете ему "+player.currentWeapon.name+" к горлу. Стража отступаете и вы сбегаете.");
    ...
    public void channelsRight(){
        monster = new Monster_Rat();
    ...
    public void castle(){
        monster = new Monster_GoldenKnight();
    ...
    public void fight() {
        ...
        if (monster.name == "Умирающий Рыцарь") {
        ...
        else if (monster.name == "Пробудившийся Самурай") {
            ui.choice1.setText("Атаковать");
            ui.choice2.setText("Убежать");
            ui.choice3.setText("");
            ui.choice4.setText("");
        ...
        else if (monster.name == "Странная Женщина") {
            ui.choice1.setText("Атаковать");
            ui.choice2.setText("");
            ui.choice3.setText("");
            ui.choice4.setText("");
        ...
        else if (monster.name == "Гигантская Крыса") {
            ui.choice1.setText("Атаковать");
            ui.choice2.setText("");
            ui.choice3.setText("");
            ui.choice4.setText("");
        ...
        else if (monster.name == "Глава Стражи") {
            ui.choice1.setText("Атаковать");
            ui.choice2.setText("");
            ui.choice3.setText("");
            ui.choice4.setText("");
    ...
    public void playerAttack() {
        ...
        ui.mainTextArea.setText("Вы атаковали " + monster.name + " и нанесли " + playerDamage+ " damage");
    ...
    public void monsterAttack1(){
        ...
        ui.mainTextArea.setText(monster.attackMessage1+ "\nВы получили " + monsterDamage+ " damage!");
    ...
    public void monsterAttack2(){
        ...
        ui.mainTextArea.setText(monster.attackMessage2+ "\nВы получили " + monsterDamage+ " damage!");
    ...
    public void monsterAttack3(){
        ...
        ui.mainTextArea.setText(monster.attackMessage3+ "\nВы получили " + monsterDamage+ " damage!");
    ...
    public void winKnight() {
        ...
        knightCloak = 1;
        player.currentWeapon = new Weapon_KnightSword();
        ui.weaponNameLabel.setText(player.currentWeapon.name);
    ...
    public void endingWin(){
        se.setFile(finalapplause); se.play();
        ui.mainTextArea.setText("Своим "+player.currentWeapon.name + " вы пронзаете рыцарю сердце и оставляете его умирать. Другая стража не смеет даже думать о том, чтоб напасть на вас. Они выдают вам " +
